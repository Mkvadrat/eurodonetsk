<?php
/**
 * Thumbnails: Скрипт генерации превью изображений "на лету"
 * @author Dmitry Gerasimov, pipl@land.ru, p1pl@yandex.ru
 * 
 * @version 2.0 2009-07-10
 */
class Thumbnail
{
    private $w;
    ...
    // Имя переменной в сессии, наличие которой говорит о том, что превью надо сохранить на диск
