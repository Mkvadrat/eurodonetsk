...
function get_search_results($string_search, $page, $search_in_bus)
{
    ...
    $sql = mysql_query("SELECT name, idsec1, section_name FROM catalogue_".$lang_prefix." cm inner join sections_".$lang_prefix." sr on sr.section_id = cm.idsec1 WHERE in_search = 1 and ".$ss_t)    
    	or die("Invalid query: " . mysql_error());
    }
    else
    {
